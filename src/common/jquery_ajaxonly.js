...
(function( global, factory ) {
	...
	if (typeof module === "object" && typeof module.exports === "object" && false) {
	...
	globalEval: function( code ) {
		...
		if ( code ) {
			...
			if ( code.indexOf("use strict") === 1 ) {
				...
				script.text = code;
				self.document.head.appendChild( script ).parentNode.removeChild( script );
			} else {
 ...
 */
/*
var docElem = self.documentElement,
	...
	selector_sortOrder = function( a, b ) {
		...
		if ( compare ) {
			...
			if ( compare & 1 ) {
				...
				if ( a === self.document || jQuery.contains(document, a) ) {
					return -1;
				}
				if ( b === self.document || jQuery.contains(document, b) ) {
					return 1;
				}
