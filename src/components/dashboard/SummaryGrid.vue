    ...
    <div class="card-body">
      <div class="d-flex align-items-start">
        <div class="flex-grow-1">
          <h5 class="card-title mb-3">Forklift Performance</h5>
        </div>
          ...
          <tbody>
            <tr>
              ...
              <td class="fw-semibold">
                <i
                  class="mdi mdi-forklift font-size-24 text-warning align-middle me-2"
                ></i
                >Forkmaster
              </td>
              <td><div class="avatar-sm"><span class="avatar-title rounded-circle bg-success text-white font-size-16"> JF </span></div></td>
              <td>200</td>
              <td>
